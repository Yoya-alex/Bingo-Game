...
class UserAdmin(admin.ModelAdmin):
    list_display = ['telegram_id', 'first_name', 'username', 'invite_code', 'referred_by', 'referral_count', 'registration_date', 'is_admin']
    list_filter = ['is_admin', 'is_active', 'registration_date']
    search_fields = ['telegram_id', 'username', 'first_name', 'invite_code']
    readonly_fields = ['telegram_id', 'registration_date', 'invite_code', 'referral_count']
