...
urlpatterns = [
    ...
    path('api/wallet-state/<int:telegram_id>/', views.wallet_state_api, name='wallet_state_api'),
    path('api/trophy-state/<int:telegram_id>/', views.trophy_state_api, name='trophy_state_api'),
    ...
    path('api/claim-mission/', views.claim_mission_api, name='claim_mission_api'),
    path('api/redeem-promo-code/', views.redeem_promo_code_api, name='redeem_promo_code_api'),
]
